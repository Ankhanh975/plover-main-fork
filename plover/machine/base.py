...
class StenotypeBase:
    ...
    def add_modifier_callback(self, callback):
        ...
        The callback will be called with a set of modifier names currently held
        (e.g. {"Control", "Shift"})."""
        self.modifier_subscribers.append(callback)
    ...
    def _notify_modifier(self, modifiers):
        for callback in list(self.modifier_subscribers):
            try:
                ...
                # Don't let a subscriber exception break capture; log and continue.
                import logging
